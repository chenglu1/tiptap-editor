...
exports.ListShortcutBadge = ListShortcutBadge;
...
function ListShortcutBadge(_a) {
    var type = _a.type, _b = _a.shortcutKeys, shortcutKeys = _b === void 0 ? list_button_1.LIST_SHORTCUT_KEYS[type] : _b;
 ...
 */
exports.ListButton = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    var _d = (0, list_button_1.useList)({
        editor: editor,
        type: type,
    ...
    return ((0, jsx_runtime_1.jsx)(ui_primitives_1.Button, __assign({ type: "button", "data-style": "ghost", "data-active-state": isActive ? "on" : "off", role: "button", tabIndex: -1, disabled: !canToggle, "data-disabled": !canToggle, "aria-label": label, "aria-pressed": isActive, tooltip: label, onClick: handleClick }, buttonProps, { ref: ref, children: children !== null && children !== void 0 ? children : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Icon, { className: "tiptap-button-icon" }), text && (0, jsx_runtime_1.jsx)("span", { className: "tiptap-button-text", children: text }), showShortcut && ((0, jsx_runtime_1.jsx)(ListShortcutBadge, { type: type, shortcutKeys: shortcutKeys }))] })) })));
});
